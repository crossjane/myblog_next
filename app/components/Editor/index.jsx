      ...
      <div className="button-group">
        ...
        >
          <img
            ...
            alt="highlighter"
            className={`w-6 ${
              editor.isActive("highlight") ? `${activeStyle}` : ""
            } `}
          />
        </button>
        <button
        ...
        <button
          ...
          className={`${
            editor.isActive("textStyle", { color: "#965AFD" })
              ? "is-active"
              : ""
          } ${editStyle}`}
        >
        ...
        <button
          ...
          className={`${
            editor.isActive("textStyle", { color: "#1E40AF" })
              ? "is-active"
              : ""
          } ${editStyle}`}
        >
        ...
        <button
          ...
          className={`${
            editor.isActive("textStyle", { color: "#047857" })
              ? "is-active"
              : ""
          } ${editStyle}`}
        >
        ...
        <button
          ...
          className={`${
            editor.isActive("textStyle", { color: "#4B5320" })
              ? "is-active"
              : ""
          } ${editStyle}`}
        >
        ...
        <button
          ...
          className={`${
            editor.isActive("textStyle", { color: "#999999" })
              ? "is-active"
              : ""
          } ${editStyle}`}
        >
        ...
        <button
          ...
          className={`${
            editor.isActive("textStyle", { color: "#64748B" })
              ? "is-active"
              : ""
          } ${editStyle}`}
        >
        ...
        <button
          ...
          className={`${
            editor.isActive("textStyle", { color: "##2E2E2E" })
              ? "is-active"
              : ""
          } ${editStyle}`}
        >
